...
// optional includes
var NZB, BufferPool, fs, zlib, XzCompressor, BrCompressor;
...
var createNzb = function(opts) {
	...
	switch(opts.compression) {
		...
		break;
		case 'brotli':
			var cOpts = opts.compressOpts;
			if(cOpts && cOpts.level !== undefined && cOpts.quality === undefined) {
				cOpts = util.extend({quality: cOpts.level}, cOpts);
			}
			nzbStream = (BrCompressor || (BrCompressor = require('iltorb').compressStream))(cOpts);
			nzbStream.pipe(outStream);
		break;
	}
