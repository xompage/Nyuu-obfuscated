...
exports.trackStats = true; // true to track stats that take a bit of CPU (bytesSent and lastActivity)
...
NNTP.prototype = {
	...
	_setState: function(state) {
		this.state = state;
		if(exports.trackStats) this.lastActivity = Date.now();
	},
